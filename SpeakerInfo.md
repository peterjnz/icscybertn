...
## Members
The NZ ICS Cyber TN is made up of members from across NZ (with some international members with an interest in NZ OT security).  Various backgrounds, including IT and ICS professionals.  Owner/operator,s as well as vendors and service providers. Various industries, including both critical (CNI) and non-critical industrial organisations.  The forum has a technical focus (not a non-technical/ management focus).  Most members have a good understanding of OT principles (skip the basics).
...
-	Talks should be technical in nature (not sales and marketing).  Talks about a vendor's product or service should focus on the problems/solutions/technical capabilities.  
...
## Finances:
The group is not financial and is run by volunteers.  There are no paid personnel (speakers, committee, panellists) for any events.  No speaking fees or travel costs will be paid. The annual summit is a ticketed event.  Funds from the event go towards conference costs and administrative costs for the group (Zoom/web/etc).
